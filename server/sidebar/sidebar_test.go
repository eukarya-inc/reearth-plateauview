...
func TestHandler(t *testing.T) {
	...
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.fetchRoot())
...
func TestHandler_getDataHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.getDataHandler())
...
func TestHandler_getAllDataHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.getAllDataHandler())
...
func TestHandler_createDataHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.createDataHandler())
...
func TestHandler_updateDataHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.updateDataHandler())
...
func TestHandler_deleteDataHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.deleteDataHandler())
...
func TestHandler_fetchTemplatesHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.fetchTemplatesHandler())
...
func TestHandler_fetchTemplateHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.fetchTemplateHandler())
...
func TestHandler_createTemplateHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.createTemplateHandler())
...
func TestHandler_updateTemplateHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.updateTemplateHandler())
...
func TestHandler_deleteTemplateHandler(t *testing.T) {
	...
	h := newHandler()
	handler := h.cms.AuthMiddleware("pid", authMethods)(h.deleteTemplateHandler())
