import {
  Field,
  Wrapper,
} from "@web/extensions/sidebar/core/components/content/common/Field/sharedComponents";
...
const PolygonClassificationType: React.FC<BaseFieldProps<"polygonClassificationType">> = ({
  value,
  editMode,
  onUpdate,
}) => {
  ...
  const handleTypeChange = useCallback(
    (selected: ClassificationType) => {
      ...
      onUpdate({
        ...
        override: {
          polygon: { classificationType: selected },
        },
      });
    },
    [onUpdate, value],
...
export default PolygonClassificationType;
