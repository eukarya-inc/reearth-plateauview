    ...
    <body>
      <div style="display: flex; flex-direction: column; max-width: 1200px; height: 100%; margin: 0 auto; padding: 20px;">
        <div style="display: flex; justify-content: right; align-items: center; gap: 8px; height: 60px;">
          <button onclick="downloadScreenshot()" style="padding: 8px; border: none; border-radius: 4px; background:var(--theme-color); color: white; cursor: pointer;">ダウンロード</button>
          <button onclick="printScreenshot()" style="padding: 9px; border: none; border-radius: 4px; background:var(--theme-color); color: white; cursor: pointer;">プリント</button>
        </div>
